...
const PROFILE_IMG = "/assets/uploads/chatgpt_image_mar_30_2026_01_06_38_am-019d3d7e-1a59-77f5-8f94-fc7a48b8818b-2.png";
const SERVICES = [
  {
    icon: "🤖",
...
function ChatbotWidget() {
  ...
  const getSmartResponse = reactExports.useCallback(
    (userMsg, history) => {
      ...
      if (msg.includes("price") || msg.includes("cost") || msg.includes("rate") || msg.includes("charge") || msg.includes("how much")) {
      ...
      if (msg.includes("n8n") || msg.includes("make.com") || msg.includes("zapier")) {
      ...
      if (msg.includes("how long") || msg.includes("timeline") || msg.includes("time") && msg.includes("take")) {
      ...
      if (msg.includes("contact") || msg.includes("phone") || msg.includes("email") || msg.includes("reach") || msg.includes("number")) {
        setStage(5);
      ...
      if (msg.includes("book") || msg.includes("appointment") || msg.includes("calendar") || msg.includes("schedule")) {
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#00c853", fontSize: "0.75rem", margin: 0 }, children: "● Online" })
                      ] })
                    ]
                  }
                ),
