...
function PageLoadOverlay() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: "100px", height: "100px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "10px", alignItems: "center" }, children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function GlassOrbs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: ORB_CONFIGS.map((orb) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
        position: "absolute",
      ...
      (entries) => {
        for (const entry of entries) {
          if (entry.isIntersecting) {
            ...
            const suffix2 = el.getAttribute("data-count-suffix") || "";
            let start = 0;
            const duration = 1800;
            const step = (timestamp) => {
              ...
              el.textContent = Math.floor(eased * target) + suffix2;
...
function AIUniverseAnimation() {
  ...
  reactExports.useEffect(() => {
    ...
    const stars = Array.from({ length: NUM_STARS }, (_) => {
    ...
    const NUM_WARPS = 80;
    const warps = Array.from({ length: NUM_WARPS }, () => ({
    ...
    function draw() {
      ...
      for (const n of nebulae) {
        n.angle += n.rotSpeed;
        drawNebula(n, n.alpha * (0.7 + 0.3 * Math.sin(t * 8e-3 + n.angle)));
      }
      for (const w of warps) {
        ...
        grad.addColorStop(
          0.5,
          w.color + Math.round(180 * (1 - dist)).toString(16).padStart(2, "0")
        );
      ...
      for (let i = 0; i < nodes.length; i++) {
        for (let j = i + 1; j < nodes.length; j++) {
          ...
          if (dist < 180) {
            ...
            grad.addColorStop(
              0,
              nodes[i].color + Math.round(alpha * 255).toString(16).padStart(2, "0")
            );
            grad.addColorStop(
              1,
              nodes[j].color + Math.round(alpha * 255).toString(16).padStart(2, "0")
            );
            ctx.beginPath();
      ...
      for (let ring = 0; ring < 3; ring++) {
        ...
        ctx.rotate(t * 8e-3 * (ring % 2 === 0 ? 1 : -1));
        ctx.beginPath();
        ctx.arc(0, 0, ringR, 0, Math.PI * 2);
        ctx.setLineDash([dashLen * 0.6, dashLen * 0.4]);
        ctx.strokeStyle = ring === 0 ? "#22D3EE88" : ring === 1 ? "#7C3AED88" : "#4f6fff88";
        ctx.lineWidth = 1.5;
        ctx.stroke();
        ctx.setLineDash([]);
        ctx.restore();
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    background: "linear-gradient(90deg, #22D3EE, #7C3AED, #4f6fff, #22D3EE)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "AI Automation · Agentic Systems · Intelligent Workflows"
                }
              )
            ]
          }
...
const PROFILE_IMG = "/assets/chatgpt_image_mar_30_2026_01_06_38_am-019d5b87-866b-76ae-8e64-4f073de1d383.png";
const SERVICES = [
  {
    icon: "🤖",
...
const CERTS = [
  {
    ...
    issuer: "IBM",
    certificateImage: "/assets/ibm_ai_foundations-019d6160-1f57-768e-9a4c-c86af5ec8486.png"
  },
  {
    icon: "📊",
    name: "IBM Machine Learning",
    issuer: "IBM",
    certificateImage: "/assets/machine_learing_in_ai-019d6171-b3a4-7749-a6c0-d04cd05abc25.png"
  },
  {
    icon: "💬",
    name: "IBM Chatbot Level 1",
    issuer: "IBM",
    certificateImage: "/assets/ibm_build_your_own_chatbot-019d6171-b884-755f-b561-a079993eb59c.png"
  },
  {
    icon: "✨",
    name: "Microsoft Generative AI",
    issuer: "Microsoft",
    certificateImage: "/assets/microsoft_all-019d6160-2e3a-777f-887d-b095838a6bd6.png"
  },
  {
    icon: "☁️",
  ...
  },
  {
    ...
    issuer: "Make.com",
    certificateImage: "/assets/make_advance-019d6153-9937-74df-ae0e-68b027b4de7f.png"
  },
  {
    icon: "🤖",
    name: "UiPath RPA",
    issuer: "UiPath",
    certificateImage: "/assets/ui_path-019d6153-9cea-7568-bd15-503b0848690b.png"
  },
  {
    icon: "💼",
    name: "DigiSkills Freelancing",
    issuer: "DigiSkills",
    certificateImage: "/assets/freelacing-019d6147-620f-7601-a1e2-59eac68a00b1.png"
  },
  {
    icon: "🗣️",
    name: "DigiSkills Communication",
    issuer: "DigiSkills",
    certificateImage: "/assets/communication_softskill-019d6171-c057-724b-8c56-a99a46a3ae5a.png"
  },
  {
    icon: "🌐",
    name: "Elements of AI",
    issuer: "MinnaLearn",
    certificateImage: "/assets/certificate-elements-of-ai-019d6153-c6de-70ae-860f-374db8f37f98.png"
  }
];
const WHY = [
  {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            backgroundImage: "linear-gradient(rgba(11,15,25,0.98), rgba(11,15,25,0.98)), linear-gradient(135deg, #4f6fff, #9b5de5)",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Book a call or reach out directly"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  style: {
                    ...
                    justifyContent: "center",
                    gap: "12px",
                    background: "linear-gradient(135deg, #2d4cff 0%, #7c3aed 50%, #9b5de5 100%)",
                    color: "#fff",
                    padding: "16px 24px",
                    borderRadius: "28px",
                    fontFamily: "Syne, sans-serif",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: "📧 nawazmubshar387@gmail.com"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "⚡ I typically respond within 1 hour"
              }
            )
          ]
        }
...
function ChatbotWidget() {
  ...
  const [hasNotification, setHasNotification] = reactExports.useState(true);
  const [showAutoPopup, setShowAutoPopup] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    style2.id = "chatbot-widget-styles";
    style2.textContent = `
  ...
  reactExports.useEffect(() => {
    ...
    const t = setTimeout(() => setShowTooltip(true), 3e3);
  ...
  reactExports.useEffect(() => {
    ...
    const hideTimer = setTimeout(() => setShowAutoPopup(false), 14e3);
    return () => {
  ...
  const addBot = reactExports.useCallback(
    (text) => {
      setMessages((prev) => [
        ...prev,
  ...
  const addUser = reactExports.useCallback(
    (text) => {
      setMessages((prev) => [
        ...prev,
  ...
  const getSmartResponse = reactExports.useCallback(
    (userMsg, history) => {
      const msg = userMsg.toLowerCase();
      const prevBotMsgs = history.filter((m) => m.role === "bot").map((m) => m.text.toLowerCase()).join(" ");
      const prevUserMsgs = history.filter((m) => m.role === "user").map((m) => m.text.toLowerCase()).join(" ");
      const mentionedAIAgent = prevUserMsgs.includes("ai agent") || prevUserMsgs.includes("agent");
      const mentionedWebsite = prevUserMsgs.includes("website") || prevUserMsgs.includes("web");
      const mentionedAutomation = prevUserMsgs.includes("automation") || prevUserMsgs.includes("automate") || prevUserMsgs.includes("workflow");
      prevUserMsgs.includes("software") || prevUserMsgs.includes("app") || prevUserMsgs.includes("dashboard");
      const hasAskedBusiness = prevBotMsgs.includes("business type") || prevBotMsgs.includes("business are you");
      const hasAskedFeatures = prevBotMsgs.includes("features") || prevBotMsgs.includes("what features");
      const hasAskedPlatform = prevBotMsgs.includes("platform") || prevBotMsgs.includes("whatsapp");
      const hasAskedScale = prevBotMsgs.includes("scale") || prevBotMsgs.includes("how big") || prevBotMsgs.includes("users");
      ...
      if (msg.includes("contact") || msg.includes("phone") || msg.includes("reach") || msg.includes("number") || msg.includes("email") && !msg.includes("agent") && !msg.includes("automat")) {
        setStage(5);
        return "Here's how to reach Haseeb directly:\n📞 +923415142049\n📧 nawazmubshar387@gmail.com\n\nHe usually responds within 1 hour! 🚀";
      }
      if (msg.includes("service") || msg.includes("what do you do") || msg.includes("what can you build") || msg.includes("what does haseeb") || msg.includes("kya service") || msg.includes("kya kaam") || msg.includes("kya deta")) {
      ...
      if (msg.includes("certif") || msg.includes("qualification") || msg.includes("degree") || msg.includes("course") || msg.includes("training") || msg.includes("ibm") || msg.includes("microsoft") || msg.includes("azure") || msg.includes("digiskills") || msg.includes("uipath") || msg.includes("elements of ai") || msg.includes("make.com cert") || msg.includes("certificate")) {
      ...
      if (msg.includes("ai agent") || msg.includes("agent") || msg.includes("chatbot") || msg.includes("chat bot") || msg.includes("voice agent") || msg.includes("voice ai")) {
        if (!hasAskedBusiness) {
        ...
        if (hasProvidedDetails) {
          if (prevUserMsgs.includes("large") || prevUserMsgs.includes("1000") || prevUserMsgs.includes("enterprise")) {
            setStage(5);
          ...
          if (prevUserMsgs.includes("small") || prevUserMsgs.includes("simple") || prevUserMsgs.includes("basic")) {
      ...
      if (msg.includes("website") || msg.includes("web design") || msg.includes("landing page") || msg.includes("portfolio site")) {
        if (!hasAskedBusiness) {
        ...
        if (hasProvidedDetails) {
          if (prevUserMsgs.includes("ecommerce") || prevUserMsgs.includes("e-commerce") || prevUserMsgs.includes("store") || prevUserMsgs.includes("payment")) {
            setStage(5);
      ...
      if (msg.includes("automation") || msg.includes("automate") || msg.includes("workflow") || msg.includes("n8n") || msg.includes("make.com") || msg.includes("zapier")) {
        if (!hasAskedBusiness) {
        ...
        if (hasProvidedDetails) {
          if (prevUserMsgs.includes("complex") || prevUserMsgs.includes("10+") || prevUserMsgs.includes("enterprise") || prevUserMsgs.includes("large")) {
            setStage(5);
            return "Complex automation projects need a custom approach. Let Haseeb assess it directly:\n📞 +923415142049\n📧 nawazmubshar387@gmail.com 🚀";
          }
          if (prevUserMsgs.includes("simple") || prevUserMsgs.includes("1-3") || prevUserMsgs.includes("small")) {
      ...
      if (msg.includes("software") || msg.includes("dashboard") || msg.includes("custom app") || msg.includes("inventory") || msg.includes("crm") || msg.includes("system")) {
        if (!hasAskedBusiness) {
        ...
        if (hasProvidedDetails) {
          if (prevUserMsgs.includes("10+") || prevUserMsgs.includes("large") || prevUserMsgs.includes("organization") || prevUserMsgs.includes("enterprise")) {
            setStage(5);
      ...
      if (msg.includes("price") || msg.includes("cost") || msg.includes("rate") || msg.includes("charge") || msg.includes("how much") || msg.includes("budget")) {
        if (mentionedAIAgent)
      ...
      if (msg.includes("how long") || msg.includes("timeline") || msg.includes("delivery") || msg.includes("time") && msg.includes("take")) {
      ...
      if (msg.includes("voice") || msg.includes("phone call") || msg.includes("phone bot")) {
      ...
      if (msg.includes("experience") || msg.includes("portfolio") || msg.includes("previous work") || msg.includes("project")) {
  ...
  const logConversation = reactExports.useCallback((userMsg, botReply) => {
    const payload = {
  ...
  const handleImageUpload = reactExports.useCallback(
    (e) => {
      ...
      const isDashboard = name.includes("dashboard") || name.includes("dash") || name.includes("admin");
      const isScreenshot = name.includes("screen") || name.includes("screenshot");
      const isLogo = name.includes("logo") || name.includes("brand");
      const isWorkflow = name.includes("flow") || name.includes("workflow") || name.includes("diagram");
      setMessages((prev) => [
        ...prev,
        {
          id: Date.now(),
...
Haseeb can build AI solutions tailored exactly to what you're showing me!`;
  ...
  const handleQuickReply = reactExports.useCallback(
    (type) => {
      var _a2;
      if (type === "services") {
  ...
  const handleMic = reactExports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    showAutoPopup && !open && !popupDismissed && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "fixed",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            style: {
              width: "100%",
              background: "linear-gradient(135deg, rgba(15,15,30,0.98), rgba(20,10,40,0.98))",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Hi 👋 Need help with your project?" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
    ...
    (showTooltip || hovered) && !open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          position: "fixed",
    ...
    !open && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          ...
          height: "110px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(124,58,237,0.4) 0%, rgba(79,111,255,0.15) 50%, transparent 70%)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        style: {
          ...
          height: "64px",
          borderRadius: "50%",
          background: open ? "linear-gradient(135deg, #ef4444, #7C3AED)" : "linear-gradient(135deg, #4f6fff, #9b5de5)",
          border: "none",
          cursor: "pointer",
          ...
          alignItems: "center",
          justifyContent: "center",
          transition: "transform 0.3s cubic-bezier(0.34,1.56,0.64,1), background 0.4s, box-shadow 0.3s",
          animation: open ? "none" : hovered ? "chatbot-bounce 0.5s ease forwards" : "chatbot-float 3.5s ease-in-out infinite, chatbot-pulse-ring 2.8s ease-in-out infinite, chatbot-auto-bounce 5s ease-in-out infinite",
          boxShadow: hovered ? "0 0 40px rgba(124,58,237,0.8), 0 8px 32px rgba(0,0,0,0.4)" : "0 0 20px rgba(79,111,255,0.4), 0 4px 20px rgba(0,0,0,0.3)",
    ...
    hasNotification && !open && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "fixed",
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          ...
          borderRadius: "24px",
          boxShadow: "0 24px 80px rgba(0,0,0,0.7), 0 0 40px rgba(124,58,237,0.18)",
          display: "flex",
          flexDirection: "column",
          overflow: "hidden",
          animation: "chatbot-slide-up 0.35s cubic-bezier(0.22,1,0.36,1) forwards"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                background: "linear-gradient(135deg, rgba(79,111,255,0.15), rgba(124,58,237,0.15))",
              ...
              children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "p",
                                {
                                  ...
                                  children: "Haseeb's AI Assistant"
                                }
                              ),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "p",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          maxWidth: "78%",
                          background: msg.role === "user" ? "linear-gradient(135deg, #4f6fff, #7C3AED)" : "rgba(255,255,255,0.06)",
                          color: "#e8eaf6",
                        ...
                        children: [
                          msg.text,
                          msg.role === "bot" && stage === 5 && msg.id === messages[messages.length - 1].id && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "a",
                            {
                ...
                isTyping && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "flex-start" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      border: listening ? "1px solid rgba(239,68,68,0.5)" : "1px solid rgba(124,58,237,0.3)",
                      cursor: "pointer",
                      fontSize: "1rem",
                      display: "flex",
                      alignItems: "center",
                      ...
                      flexShrink: 0,
                      transition: "all 0.2s",
                      animation: listening ? "chatbot-mic-pulse 1s ease-in-out infinite" : "none"
                    },
                    children: "🎤"
                  }
                ),
      ...
      children: FAQS.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            openIdx === i && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
...
function BeforeAfterSection({ openModal }) {
  const [counts, setCounts] = reactExports.useState({ time: 0, leads: 0, replies: 0 });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      style: {
        background: "linear-gradient(180deg,#04050a 0%,#0a0612 50%,#04050a 100%)",
        padding: "6rem max(1.5rem,calc((100vw - 1200px)/2))",
        position: "relative",
        overflow: "hidden"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, pointerEvents: "none" }, children: Array.from({ length: 24 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  children: "This Is What Automation Does to Your Business"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "See exactly how AI automation transforms your daily workflow."
                }
              )
            ]
          }
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              children: "Before Automation"
                            }
                          )
                        ]
                      }
                    ),
                    beforeRows.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          display: "flex",
                          ...
                          justifyContent: "space-between",
                          padding: "1rem 1.5rem",
                          borderBottom: i < beforeRows.length - 1 ? "1px solid rgba(239,68,68,0.08)" : "none",
                          gap: "0.75rem"
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        boxShadow: "0 0 30px rgba(124,58,237,0.5), 0 0 60px rgba(34,211,238,0.2)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        fontSize: "1.3rem",
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              children: "After Automation"
                            }
                          )
                        ]
                      }
                    ),
                    afterRows.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          display: "flex",
                          ...
                          justifyContent: "space-between",
                          padding: "1rem 1.5rem",
                          borderBottom: i < afterRows.length - 1 ? "1px solid rgba(34,211,238,0.08)" : "none",
                          gap: "0.75rem"
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          "div",
          {
            ...
            children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.8rem", marginBottom: "0.3rem" }, children: s.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onMouseEnter: (e) => {
              ...
              e.currentTarget.style.boxShadow = "0 12px 50px rgba(124,58,237,0.6)";
            },
            onMouseLeave: (e) => {
...
function App() {
  ...
  const ctaCanvasRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    ...
    for (let i = 0; i < 60; i++) {
      particles.push({
        ...
        y: Math.random(),
        r: Math.random() * 3 + 1,
        dx: (Math.random() - 0.5) * 3e-4,
        dy: (Math.random() - 0.5) * 3e-4,
        alpha: Math.random() * 0.5 + 0.2
      });
    }
    function resize() {
      var _a2;
      const rect = (_a2 = canvas.parentElement) == null ? void 0 : _a2.getBoundingClientRect();
      if (rect) {
  ...
  const handleSearch = (query) => {
    ...
    for (const s of SERVICES) {
      if (s.title.toLowerCase().includes(q) || s.desc.toLowerCase().includes(q) || s.details.some((d) => d.toLowerCase().includes(q))) {
        results.push({
          label: s.title,
          section: "Service",
          action: () => {
    ...
    for (const sec of sections) {
      if (sec.label.toLowerCase().includes(q) || sec.keywords.some((k) => k.includes(q))) {
        results.push({
          label: sec.label,
          section: "Section",
          action: () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          ...
                          display: "flex",
                          alignItems: "center",
                          background: searchFocused ? "rgba(79,111,255,0.08)" : "rgba(255,255,255,0.04)",
                          border: `1.5px solid ${searchFocused ? "rgba(79,111,255,0.5)" : "rgba(255,255,255,0.08)"}`,
                          borderRadius: "14px",
                          transition: "all 0.3s ease",
                          boxShadow: searchFocused ? "0 0 20px rgba(79,111,255,0.15)" : "none"
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                    ...
                    searchResults.length > 0 && searchFocused && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          position: "absolute",
                          ...
                          borderRadius: "14px",
                          boxShadow: "0 20px 60px rgba(0,0,0,0.6), 0 0 30px rgba(79,111,255,0.1)",
                          backdropFilter: "blur(16px)",
                          zIndex: 200,
                          overflow: "hidden",
                          animation: "fadeSlideUp 0.2s ease"
                        },
                        children: searchResults.map((result, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            type: "button",
                            ...
                            onMouseEnter: (e) => {
                              e.currentTarget.style.background = "rgba(79,111,255,0.1)";
                            },
                            onMouseLeave: (e) => {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  style: {
                                    ...
                                    padding: "2px 10px",
                                    borderRadius: "100px",
                                    background: result.type === "service" ? "rgba(79,111,255,0.15)" : result.type === "cert" ? "rgba(155,93,229,0.15)" : "rgba(0,212,255,0.15)",
                                    color: result.type === "service" ? "#93c5fd" : result.type === "cert" ? "#c4b5fd" : "#67e8f9",
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, fontSize: "0.9rem" }, children: result.label }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    ...
                    width: "350px",
                    height: "350px",
                    background: "radial-gradient(circle, rgba(155,93,229,0.16) 0%, transparent 70%)",
                    borderRadius: "50%",
                    pointerEvents: "none",
                    animationDelay: "1.5s"
                  }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(GlassOrbs, { mouseX, mouseY }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "h1",
                            {
                              ...
                              children: [
                                ["Stop", "Manual", "Work."].map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                ...
                                ["Scale", "Your", "Business"].map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                    className: "word-reveal",
                                    style: {
                                ...
                                ["with", "AI", "Automation"].map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                    className: "word-reveal",
                                    style: {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              ...
                              children: "I build intelligent AI agents and automation systems that save time, reduce costs, and help businesses grow faster."
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-ring-1" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-ring-2" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-ring-3" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-ring-glow" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "spin-ring",
                              style: {
                                ...
                                inset: "-10px",
                                borderRadius: "50%",
                                background: "conic-gradient(from 0deg, #4f6fff, #9b5de5, #00d4ff, #4f6fff)",
                                padding: "3px",
                                zIndex: 0
                              },
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h2",
                {
                  ...
                  children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-cyan", children: "Real Time" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Every automation, agent, and workflow — live and intelligent."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(NeuralCanvas, {})
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.5rem" }, children: card.emoji }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: card.color, fontSize: "0.72rem" }, children: [
                            "✓ ",
                            card.sub
                          ] })
                        ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AIUniverseAnimation, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "section-divider" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "section",
          {
            style: {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            right: "20%",
                            height: "2px",
                            background: "linear-gradient(90deg, transparent, #4f6fff, #9b5de5, transparent)",
                            borderRadius: "2px"
                          }
                        }
                      ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3rem" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "From idea to deployed agent — I build intelligent systems that save time, cut costs, and scale your business 24/7."
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.2rem", marginBottom: "1rem" }, children: item.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge", children: "Who I Am" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-quote-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          style: {
                            color: "#e2e8f0",
                          ...
                          children: `"I'm Haseeb Nawaz — Agentic AI Engineer & Automation Builder from Lahore. I build intelligent systems that save time and scale businesses."`
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: `🚀 Hi, I'm Haseeb Nawaz — a passionate Agentic AI Engineer and AI Automation Builder from Lahore, Pakistan.
...
• No-code & low-code automation`
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: [
                              "n8n",
                              "Make.com",
                              "GoHighLevel",
                              "OpenAI APIs",
                            ...
                            "div",
                            {
                              ...
                              children: [
                                ...
                                "div",
                                {
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.2rem" }, children: s.icon }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#d1d5db", fontSize: "0.9rem" }, children: s.text }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: "auto", color: "#4f6fff" }, children: "✓" })
                                  ]
                                },
                                s.text
                              ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3rem" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge purple", children: "What I Build" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6b7280" }, children: "End-to-end AI automation solutions for your business" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: SERVICES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2rem", marginBottom: "0.75rem" }, children: s.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "h3",
                          {
                            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3rem" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge cyan", children: "Live Work" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    style: {
                    ...
                    children: "Real Projects I've Built"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6b7280" }, children: "AI automation systems delivered for real businesses" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: PROJECTS.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.2rem", marginBottom: "1rem" }, children: p.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "h3",
                          {
                            style: {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#9ca3af", fontSize: "0.875rem" }, children: p.desc })
                      ]
                    },
                    p.title
                  ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3rem" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge green", children: "Credentials" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    style: {
                    ...
                    children: "Certifications & Credentials"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6b7280" }, children: "Industry-recognized credentials in AI and automation" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: CERTS.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      "data-ocid": `certifications.item.${i + 1}`,
                      className: "service-card cert-card-anim premium-card",
                      onClick: () => c.certificateImage && setSelectedCert(c.certificateImage),
                      onKeyDown: (e) => {
                        if (e.key === "Enter" && c.certificateImage)
                          setSelectedCert(c.certificateImage);
                      },
                      role: c.certificateImage ? "button" : void 0,
                      tabIndex: c.certificateImage ? 0 : void 0,
                      style: {
                        borderRadius: "14px",
                        padding: "1.5rem 1rem",
                        textAlign: "center",
                        cursor: c.certificateImage ? "pointer" : void 0
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.8rem", marginBottom: "0.75rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cert-icon-anim", children: c.icon }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            style: {
                        ...
                        c.certificateImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            style: {
                              color: "#4f6fff",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3rem" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge purple", children: "Why Haseeb" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6b7280" }, children: "The advantages that make my work stand out" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  className: "why-grid",
                  children: WHY.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "service-card premium-card",
                      style: {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2rem", marginBottom: "0.75rem" }, children: w.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "h3",
                          {
                            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge cyan", children: "Let's Connect" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3rem" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-badge", children: "Questions" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6b7280" }, children: "Everything you need to know" })
              ] }),
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  ...
                  position: "relative",
                  overflow: "hidden",
                  boxShadow: "0 20px 80px rgba(124,58,237,0.45), 0 0 0 1px rgba(255,255,255,0.08)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "canvas",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Let's build intelligent systems that work for you — 24/7."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(BeforeAfterSection, { openModal }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "footer",
          {
            style: {
              background: "linear-gradient(180deg, rgba(79,111,255,0.04) 0%, #04050a 100%)",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Haseeb Nawaz — AI Automation Engineer"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#4b5563", fontSize: "0.8rem" }, children: [
                      "© ",
                      (/* @__PURE__ */ new Date()).getFullYear(),
                      " All rights reserved."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "1.5rem" }, children: navLinks.slice(0, 3).map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => scrollTo(l.id),
        ...
        showModal && /* @__PURE__ */ jsxRuntimeExports.jsx(ContactModal, { onClose: closeModal }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoadOverlay, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MouseTrail, {}),
      ...
      ` }),
        selectedCert && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        selectedService && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", marginBottom: "1rem" }, children: selectedService.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { listStyleType: "none", padding: 0, margin: 0 }, children: selectedService.details.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
                      style: {
                        display: "flex",
